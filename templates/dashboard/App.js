      ...
      <NavigationContainer>
        ...
        <Tab.Navigator screenOptions={{ headerShown: false, tabBarStyle: { backgroundColor: '#161b22', borderTopColor: '#30363d' }, tabBarActiveTintColor: '#58a6ff', tabBarInactiveTintColor: '#8b949e' }}>
          <Tab.Screen
            name="Home"
            component={DashStack}
            options={{ tabBarLabel: 'Overview', tabBarButtonTestID: 'tab-overview', tabBarAccessibilityLabel: 'Tab: Overview' }}
          />
          <Tab.Screen
            name="History"
            component={HistoryScreen}
            options={{ title: 'History', tabBarButtonTestID: 'tab-history', tabBarAccessibilityLabel: 'Tab: History' }}
          />
          <Tab.Screen
            name="Settings"
