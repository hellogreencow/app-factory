      ...
      <NavigationContainer>
        ...
        <Tab.Navigator screenOptions={{ headerShown: false, tabBarStyle: { backgroundColor: '#161b22', borderTopColor: '#30363d' }, tabBarActiveTintColor: '#58a6ff', tabBarInactiveTintColor: '#8b949e' }}>
          <Tab.Screen
            ...
            options={{ tabBarLabel: 'Browse', tabBarButtonTestID: 'tab-browse', tabBarAccessibilityLabel: 'Tab: Browse' }}
          />
          <Tab.Screen
            name="Bookmarks"
            component={BookmarksScreen}
            options={{ title: 'Bookmarks', tabBarButtonTestID: 'tab-bookmarks', tabBarAccessibilityLabel: 'Tab: Bookmarks' }}
          />
          <Tab.Screen
            name="Settings"
